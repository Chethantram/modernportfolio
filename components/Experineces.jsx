    ...
    <section ref={experienceRef} id="experience" className="space-y-6 py-20 md:py-32">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 mt-20">
        {STATIC_EXPERIENCES.map((it) => (
          <Card
            key={it.id}
            className="service-card border-2 border-cyan-700 dark:border-cyan-200/40 rounded-2xl bg-gray-50 dark:bg-gray-700/20 flex flex-col h-full"
          >
            <CardHeader>
              <CardTitle className="space-y-3">
                ...
                <div className="text-xs italic text-muted-foreground service-animate">
                  {it.start} {it.current ? "— Present" : it.end ? `— ${it.end}` : ""}
                </div>
              </CardTitle>
            </CardHeader>
            ...
            <CardContent className="flex-1">
              ...
              {it.tech && (
                <div className="mt-2 text-[12px] text-muted-foreground service-animate">
                  <strong className="text-blue-500">Tech:</strong> {it.tech}
                </div>
              )}
            </CardContent>
              ...
              <div className="flex gap-2 service-animate">
                {it.link && (
                  <Button
                    ...
                    className="px-5 py-0 rounded-4xl text-gray-800 bg-transparent dark:hover:bg-black/80 hover:bg-gray-300 border-2 dark:text-white border-gray-800/30 dark:border-cyan-100/30"
                    size="sm"
                  >
